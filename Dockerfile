...
ENV JOYOMNI_DEVICE=cuda:0 \
    ...
    JOYOMNI_CACHE_ROOT=/runpod-volume/joyai/cache/rtx-pro-6000-blackwell-torch291-cu128 \
    JOYOMNI_CACHE_READY_MARKER=/runpod-volume/joyai/cache/rtx-pro-6000-blackwell-torch291-cu128/ready.json \
