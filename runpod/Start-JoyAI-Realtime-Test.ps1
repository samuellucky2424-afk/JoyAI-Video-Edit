...
try {
    ...
    if (
        ...
        throw "JoyAI became reachable without the required compiled VAE and CUDA graph. Stop the worker and inspect its optimization log before testing."
    }
    Write-Host "Verified: compiled VAE and CUDA graph are active."
